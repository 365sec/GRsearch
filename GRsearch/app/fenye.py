    ...
    if s_type == "webscan":
        ...
        response = client.search(
                             ...
                             body={
                                   ...
                                   "query": {
                                             "match_phrase":{
                                                      "p80.http.get.body": search_content
                                                      }
                                             },
                                   "highlight":{
                                                "pre_tags":['<span class="keyWord">'],
        ...
        for hit in response["hits"]["hits"]:
            hit_dict = {}
            if "p80.http.get.body" in hit["highlight"]:
                hit_dict["result"] = "".join(hit["highlight"]["p80.http.get.body"])
            else:
                hit_dict["result"] = hit["_source"]["p80.http.get.body"]
        ...
        return render(request, 'fenye_portscan.html',{
                                             "all_hits":hit_list, 
                                             "search_content": search_content, 
                                             "total_nums":total_nums, 
                                             "time_took":time_took, 
